...
def train():
    ...
    symbols = ['002396', '002713']

    # benchmark_kl_pd = ABuSymbolPd.make_kl_df(symbols, data_mode=EMarketDataSplitMode.E_DATA_SPLIT_SE,
    #
    #                                          start='2018-10-01')
    ...
    benchmark = AbuBenchmark(start='2018-10-01')
    ...
    capital = AbuCapital(50000, benchmark)
    orders_pd, action_pd, all_fit_symbols_cnt = ABuPickTimeExecute.do_symbols_with_same_factors(symbols,
                                                                                                benchmark,
                                                                                                buy_factors,
                                                                                                sell_factors,
                                                                                                capital,
